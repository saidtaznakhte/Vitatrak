...
const VitalsMonitor: React.FC<VitalsMonitorProps> = ({ onScan }) => {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-grow">
            ...
            <p className="font-bold text-lg text-text-primary-light dark:text-text-primary-dark">72 bpm</p>
          </div>
          <span className="text-sm font-semibold text-accent py-1 px-3 bg-accent/10 rounded-full">Resting</span>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-grow">
            ...
            <p className="font-bold text-lg text-text-primary-light dark:text-text-primary-dark">120/80 mmHg</p>
          </div>
          <span className="text-sm font-semibold text-accent py-1 px-3 bg-accent/10 rounded-full">Normal</span>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-grow">
            ...
            <p className="font-bold text-lg text-text-primary-light dark:text-text-primary-dark">98%</p>
          </div>
          <span className="text-sm font-semibold text-accent py-1 px-3 bg-accent/10 rounded-full">Normal</span>
        </div>
      </div>
